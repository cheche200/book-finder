...
public class FacetFields {
    ...
    private List<String> videoClassification = null;
    @JsonIgnore
    ...
    @JsonProperty("video_classification")
    public List<String> getVideoClassification() {
        return videoClassification;
    }

    @JsonProperty("video_classification")
    public void setVideoClassification(List<String> videoClassification) {
